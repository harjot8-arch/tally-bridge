 ...
 *
 * Why not Intl.NumberFormat('en-IN') in the UI: without full ICU it silently falls back to
 * en-US grouping and prints ₹1,42,34,110 as ₹14,234,110 (ARCHITECTURE.md pins this).
 * `formatMoney` is the hand-rolled Indian grouping every surface shares.
 */
